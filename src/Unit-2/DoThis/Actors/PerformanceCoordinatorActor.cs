...
{
    public class PerformanceCoordinatorActor : ReceiveActor
    {
        public class Watch
        {
        ...
        public PerformanceCoordinatorActor(IActorRef chartingActor)
            : this(chartingActor, new Dictionary<CounterType, IActorRef>()) { }

        public PerformanceCoordinatorActor(IActorRef chartingActor, Dictionary<CounterType, IActorRef> counterActors)
        {
